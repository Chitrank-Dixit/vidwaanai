...
class LoadTester:
    def __init__(self, queries: List[str], concurrency: int = 10, duration_sec: int = 30):
    ...
    def run(self):
        ...
        agent = get_agent()
        print(f"Starting load test with {self.concurrency} threads for {self.duration_sec} seconds...")
        self.running = True
        threads = []
