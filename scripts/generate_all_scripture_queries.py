...
def main():
    ...
    logger.info(f"Filtered out {ignored_count} verses (Ramayana / Bhagavad Gita duplicates)")
    ...
    for scripture_name, verses in scriptures_data.items():
        ...
        logger.info(f"Processing '{scripture_name}': {total_verses} verses -> {num_batches} batches under {target_dir}")
