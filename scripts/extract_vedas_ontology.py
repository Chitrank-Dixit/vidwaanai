...
def extract_relationships_from_entities(entities_present: set) -> list:
    ...
    if "Agni" in entities_present and "Yajna" in entities_present:
        rels.append({
            ...
            "to": "Yajna",
            "type": "RELATED_TO",
            "attributes": {"context": "Agni is the fire medium and priest through whom offerings are made in Yajna."}
        })
    ...
    if "Soma" in entities_present and "Yajna" in entities_present:
        rels.append({
            ...
            "to": "Yajna",
            "type": "RELATED_TO",
            "attributes": {"context": "Soma juice libation is a key offering in Vedic Yajna."}
        })
    ...
    if "Indra" in entities_present and "Soma" in entities_present:
        rels.append({
            ...
            "to": "Soma",
            "type": "RELATED_TO",
            "attributes": {"context": "Indra consumes Soma juice to gain divine strength for battles."}
        })
    ...
    if "Mitra" in entities_present and "Varuna" in entities_present:
        rels.append({
            ...
            "to": "Varuna",
            "type": "RELATED_TO",
            "attributes": {"context": "Mitra and Varuna are dual deities (Mitra-Varuna) who uphold moral law."}
        })
    ...
    if "Purusha" in entities_present and "Yajna" in entities_present:
        rels.append({
            ...
            "attributes": {"context": "The primeval Purusha is sacrificed in the cosmic Yajna to create manifestation."}
        })
    ...
    for d in deities:
        if d in entities_present and "Rta" in entities_present:
            rels.append({
                ...
                "to": "Rta",
                "type": "RELATED_TO",
                "attributes": {"context": f"Lord {d} is a guardian and upholder of the cosmic order Rta."}
            })
