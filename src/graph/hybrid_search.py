...
class HybridSearcher:
    ...
    def search(self, query: str, top_k: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                return {"graph_results": [], "vector_results": [], "fused_context": "", "sources": []}
    ...
    def _fuse_context(self, graph_results: List[Dict], vector_results: List[Dict]) -> str:
        ...
        if vector_results:
            ...
            for verse in vector_results:
                context_parts.append(f"{verse['scripture']} {verse['chapter']}.{verse['verse']}: {verse['translation']}")
    ...
    def _format_vector_context(self, vector_results: List[Dict]) -> str:
        ...
        for verse in vector_results:
            parts.append(f"{verse['scripture']} {verse['chapter']}.{verse['verse']}: {verse['translation']}")
        return "\n".join(parts)
