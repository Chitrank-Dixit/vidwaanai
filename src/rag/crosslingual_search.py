...
class CrosslingualSearch:
    ...
    def search_across_languages(self, query: str, target_languages: List[str], 
                                corpus_embeddings: Any, top_k: int = 10) -> Dict[str, List[Dict]]:
        """
        ...
        results = self.multilingual_search.search(query, corpus_embeddings, top_k=top_k * len(target_languages))
