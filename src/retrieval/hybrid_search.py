...
class HybridSearch:
    def __init__(self, bm25_search, vector_search_func, bm25_weight: float = 0.3, semantic_weight: float = 0.7):
        """
    ...
    def combine_results(self, bm25_results: List[Dict], semantic_results: List[Dict], top_k: int = 10) -> List[Dict]:
        ...
        for res in semantic_results:
            ...
            if doc_id not in combined_scores:
                ...
                combined_scores[doc_id]['semantic_score'] = res.get('normalized_score', 0.0)
        ...
        for doc_id, scores in combined_scores.items():
            final_score = (self.bm25_weight * scores['bm25_score'] + 
