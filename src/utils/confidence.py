...
def calculate_confidence_score(
    ...
    if answer_tokens:
        ...
        token_overlap_score = overlap_ratio * 100 # Using same metric for now as per user logic
    else:
        match_score = 0
    ...
    if confidence >= 80:
        ...
        level = "Fair"
        warning = "This answer has moderate uncertainty. Please verify with retrieved verses."
    else:
        level = "Low"
