...
class MalayalamProcessor(LanguageProcessor):
    ...
    def __init__(self):
        ...
        self.stop_words = set([
            'aanu', 'aay', 'aakam', 'aakaram', 'aayirunnu',
            'atha', 'ee', 'o', 'kuttal', 'enn', 'ennanu',
            'injan', 'a', 'undayil', 'undaya', 'undakka',
            'vendu', 'vendutal', 'poleye', 'maatram', 'maaran',
            'valichey', 'valecha', 'nayan', 'nayanu', 'payyan',
            'oru', 'njan', 'ente', 'ningal', 'avar', 'athu', 'ithu',
            'ippol', 'appol', 'engane', 'enthinu', 'ethra'
        ])
