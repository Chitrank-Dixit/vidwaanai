...
class QueryRequest(BaseModel):
    ...
    question: str = Field(..., min_length=3, max_length=5000, description="The user's question about Vedic scriptures.")
    session_id: Optional[str] = Field(None, description="Session ID for conversation history context.")
    context: Optional[Dict[str, Any]] = Field(None, description="Optional extra context or filters.")
    temperature: Optional[float] = Field(0.7, ge=0.0, le=1.0, description="LLM sampling temperature.")
    max_tokens: Optional[int] = Field(1000, ge=50, le=4096, description="Max tokens for the answer.")
