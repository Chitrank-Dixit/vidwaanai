...
class TestRAGPipeline:
    ...
    def test_retrieve_flow(self):
        ...
        with unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.ContextAwareReranker') as mock_reranker, \
             unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.FuzzyMatcher') as mock_fuzzy, \
             unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.SynonymHandler') as mock_synonym:
            ...
            mock_reranker_instance.rerank.return_value = [{"text": "result", "score": 0.9}]
            ...
            mock_hybrid.search.assert_called_with("expanded query", top_k=15) # top_k * 3
    ...
    def test_retrieve_no_correction(self):
        with unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.ContextAwareReranker'), \
             unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.FuzzyMatcher') as mock_fuzzy, \
             unittest.mock.patch('src.retrieval.advanced_retrieval_pipeline.SynonymHandler') as mock_synonym:
