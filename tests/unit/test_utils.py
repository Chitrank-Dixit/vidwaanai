...
import os
from src.ingestion.utils import is_processed, mark_processed, should_process, TRACKING_FILE
...
def test_calculate_confidence_score_high_match():
    ...
    retrieved_verses = [
        ...
        {"embedding": [0.9, 0.1], "text": "similar text", "translation": "similar text"}
    ]
    generated_answer = "target text similar text"
    
    result = calculate_confidence_score(question_emb, retrieved_verses, generated_answer)
