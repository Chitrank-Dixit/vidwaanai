...
class TestLanguageDetector:
    ...
    def test_detect_hindi(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_gujarati(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_tamil(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_telugu(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_kannada(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_bengali(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_marathi(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_malayalam(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_mixed_language(self, detector: LanguageDetector) -> None:
    ...
    def test_detect_single_word(self, detector: LanguageDetector) -> None:
        text = "Namaste"
    ...
    def test_detect_long_text(self, detector: LanguageDetector) -> None:
        text = (
            "This is a longer text to ensure that the language detector works correctly for larger inputs. "
            * 10
        )
    ...
    def test_detect_with_numbers(self, detector: LanguageDetector) -> None:
        text = "The year is 2024 and the time is 10:00 AM."
        code, _, _ = detector.detect_language(text)
        assert code == "en"

    def test_detect_with_urls(self, detector: LanguageDetector) -> None:
        text = "Check out https://google.com for more info."
        code, _, _ = detector.detect_language(text)
        assert code == "en"

    def test_detect_special_characters(self, detector: LanguageDetector) -> None:
    ...
    def test_handle_none_input(self, detector: LanguageDetector) -> None:
    ...
    def test_handle_whitespace_only(self, detector: LanguageDetector) -> None:
        code, name, conf = detector.detect_language("   ")
        assert code == "en"
        assert conf == 0.0

    def test_handle_numbers_only(self, detector: LanguageDetector) -> None:
        code, name, conf = detector.detect_language("12345 67890")
        assert code == "en"  # Default fallback likely
        assert conf == 0.0  # Low confidence

    def test_handle_unsupported_language(self, detector: LanguageDetector) -> None:
        # French text
    ...
    def test_high_confidence(self, detector: LanguageDetector) -> None:
        text = "This is a very clear English sentence."
        _, _, conf = detector.detect_language(text)
        assert conf > 0.8

    def test_ambiguous_text(self, detector: LanguageDetector) -> None:
    ...
    def test_performance_short_text(self, detector: LanguageDetector) -> None:
        text = "Hello world"
        start = time.time()
    ...
    def test_performance_long_text(self, detector: LanguageDetector) -> None:
