...
class TestVectorDB:
    ...
    def test_retrieve_verses(self, db_manager):
        ...
        mock_cursor.fetchall.return_value = [
            {'id': 1, 'scripture': 'Gita', 'chapter': 1, 'verse': 1, 'text': 'Text', 'translation': 'Trans', 'similarity': 0.9}
        ]
    ...
    def test_retrieve_verses_fallback(self, db_manager):
        ...
        mock_cursor.fetchall.side_effect = [
            [{'id': 1, 'scripture': 'Gita', 'chapter': 1, 'verse': 1, 'text': 'Text', 'translation': 'Trans'}] # Fallback result
        ]
